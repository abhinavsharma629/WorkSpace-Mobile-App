...
export default class WebView1 extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      hasLink: false,
      currentEmbedLink: "",
      curr_showLink: "https://api.dropboxapi.com/2/files/get_temporary_link"
    };
  }
  ...
  componentDidMount() {
    ...
    this.getLink(
      this.props.navigation.state.params.currentEmbedLink,
      this.props.navigation.state.params.access_token,
      this.props.navigation.state.params.curr_fileId
    );
  }
  ...
  UNSAFE_componentWillReceiveProps(nextProp) {
    ...
    this.getLink(
      nextProp.navigation.state.params.currentEmbedLink,
      nextProp.navigation.state.params.access_token,
      nextProp.navigation.state.params.curr_fileId
    );
  }

  getLink(path, access_token, fileId) {
    ...
    fetch("https://api.dropboxapi.com/2/sharing/create_shared_link", {
      ...
      .then(responseJson => {
        ...
        this.setState({ hasLink: true, curr_showLink: responseJson.url });
      });
  }
      ...
      return (
        <View style={styles.container}>
          ...
          <View style={{ flexDirection: "row", height: 50 }}>
            ...
            >
              {this.state.curr_showLink.substring(0, 40)}...
            </Text>
          </View>
          <Divider
          ...
          <Text />
          <WebView
            source={{ uri: this.state.curr_showLink }}

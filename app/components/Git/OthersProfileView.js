...
export default class OthersProfileView extends Component {
  constructor(props)  {
          super(props);
          this.state={
    ...
    componentDidMount(){
      ...
      console.log("Component did mount of OthersProfileView")
  ...
  render() {
    return (
      ...
      <Text>I'm the OthersProfileView component</Text>
      </View>
    );
  }
}
